...
class SC2Env(environment.Base):
    ...
    def _get_observations(self, target_game_loop):
        ...
        # TODO merge fix(self._obs, self._agent_obs)
    ...
    def _observe(self, target_game_loop):
        ...
        # TODO merge fix(self._obs, agent_obs)
        ...
        return tuple(environment.TimeStep(
            ...
            observation=o, game_info=info) for r, o, info in zip(reward, self._agent_obs, game_info))
